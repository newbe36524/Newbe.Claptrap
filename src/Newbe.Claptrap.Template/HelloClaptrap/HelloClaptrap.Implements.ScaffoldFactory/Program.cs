...
namespace HelloClaptrap.Implements.ScaffoldFactory
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            const string interfaceProjectName = "HelloClaptrap.Interfaces";
            var interfaceProjectFullPath = FindProjectPath(interfaceProjectName);
            const string scaffoldProjectName = "HelloClaptrap.Implements.Scaffold";
