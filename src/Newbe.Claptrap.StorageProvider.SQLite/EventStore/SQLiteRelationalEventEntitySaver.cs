...
{
    public class SQLiteRelationalEventEntitySaver : IEventEntitySaver<EventEntity>
    {
        ...
        public SQLiteRelationalEventEntitySaver(
        ...
        private readonly struct RelationalEventBatchOperatorKey : IBatchOperatorKey
        {
            ...
            {
                return
                    $"{nameof(SQLiteRelationalEventEntitySaver)}-{_connectionName}-{_eventTableName}";
            }
        }
